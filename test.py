import torch
#import the package in setup.py
...
if __name__ == '__main__':
    ...
    # function is defined in interpolation.cpp
    t = time.time()
    ...
    torch.cuda.synchronize()
    print('pytoch time', time.time() - t, 's')
    print(torch.allclose(out_py, out_cuda)) #check if the outputs same
